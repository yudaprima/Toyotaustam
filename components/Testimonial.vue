<template>
  <div class="container mx-auto mt-9">
    ...
    >
      ...
      >
        <p class="">
          <span class="font-bold text-red text-lg"> “ </span>
        ...
        <div class="flex items-center mt-4">
          ...
          <div class="flex flex-col ml-2 justify-between">
            <span class="font-semibold text-red text-sm"> Yhunei </span>
          </div>
        </div>
      </div>
      <div
      ...
      >
        ...
        <div class="flex items-center mt-4">
          ...
          <div class="flex flex-col ml-2 justify-between">
            <span class="font-semibold text-red text-sm"> Agus Hermanto </span>
          </div>
        </div>
      </div>
      <div
      ...
      >
        ...
        <div class="flex items-center mt-4">
          ...
          <div class="flex flex-col ml-2 justify-between">
            <span class="font-semibold text-red text-sm"> Dony saputra </span>
          </div>
        </div>
      </div>
    </div>
